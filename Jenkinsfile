            ...
            steps {
                withBuildConfiguration {
                    sshagent(credentials: [SSH_ID_REF]) {
                        sh '''
                            ssh -o StrictHostKeyChecking=no root@ec2-18-143-167-76.ap-southeast-1.compute.amazonaws.com "docker run --detach --name devops-mgm-training-todo-app -p 8769:8000 gaumeodathanh/devops-mgm-training-todo-app:0.0.2"
                        '''
                    }
                }
            }
